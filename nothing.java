...
{	
	...
	public static void hunt(String user_name, int hp, int atk, int def, int exp)
	{
		...
		you.askHunt(a,b,c,d,hp,atk,def,exp,mon_atk,user_name,mon_def,mon_hp,mon_name);
	}
	public static void askHunt(String a, String b, String c, String d,  int hp, int atk, int def,int exp, int mon_atk,String user_name,  int mon_def, int mon_hp, String mon_name)
	{
		Scanner up = new Scanner(System.in);
		nothing you = new nothing();
		Random rand = new Random();
		...
		{
			you.defense(a,b,c,d,atk,mon_def,mon_hp,mon_atk, mon_name, def, exp, user_name, hp);
		}
	}
	...
	public static void defense(String a, String b, String c, String d, int atk, int mon_def, int mon_atk, int mon_hp, String mon_name, int def, int exp, String user_name, int hp)
	{
		nothing you = new nothing();
